...
@section('title', 'Create New Blog | ' . Auth::user()->name)
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 d-inline align-middle">Create New Blog</h1>
                    <p class="text-muted mb-0">Share your thoughts and ideas with the world</p>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              name="description" 
                                              rows="3" 
                                              placeholder="Brief description of your blog...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="status-options">
                                        <div class="status-option">
                                            <label class="status-card selected" for="status_draft">
                                                <input type="radio" 
                                                       id="status_draft" 
                                                       name="status" 
                                                       value="draft" 
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">Save as draft to continue later</small>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="status-option">
                                            <label class="status-card" for="status_published">
                                                <input type="radio" 
                                                       id="status_published" 
                                                       name="status" 
                                                       value="published" 
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">Make it live immediately</small>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group" id="publishDateGroup" style="display: none;">
                                    ...
                                    @error('published_at')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="help-text">Leave empty to publish immediately</div>
                                </div>
