...
<head>
	...
	<meta name="keywords" content="meet my tech, bootstrap, bootstrap 5, admin, dashboard, template, responsive, css, sass, html, theme, front-end, ui kit, web">
	...
	<title>Meet My Tech {{ Auth::user()->name }} Dashboard</title>
