...
<head>
	...
	<title>Education | {{ Auth::user()->name }}</title>
...
<body>
	<div class="wrapper">
							...
							<div class="card mb-3">
								<div class="card-body">
									<div class="d-flex justify-content-between align-items-center mb-2">
                                        <h5 class="h6 card-title mb-0">Education 1</h5>
                                        <a href="#" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addEducationModal">
									...
									<ul class="list-unstyled mb-0">
										...
										<li class="mb-1">Precentage / CGPA <a href="#">100%</a></li>
										<li class="mb-1">University <a href="#">VTU</a></li>
										<li class="mb-1">Description <a href="#">sdtrfghujhygtfdesefdgfhgjhb</a></li>
									</ul>
								</div>
								<hr class="my-0" />
								<div class="card-body">
		...
		<!-- Edit Profile Modal -->
		<div class="modal fade" id="addEducationModal" tabindex="-1" aria-labelledby="editProfileLabel" aria-hidden="true">
						...
						<div class="modal-body">
							<div class="row mb-3">
								<div class="col-md-8">
									...
									<div class="mb-3">
										<label for="precentage" class="form-label">Precentage *</label>
										<input type="text" class="form-control" id="precentage" name="precentage" value="" required>
									</div>
									<div class="mb-3">
									...
									<div class="mb-3">
										...
										<input type="text" class="form-control" id="to_date" name="to_date" value="" required>
									</div>
									<div class="mb-3">
										<label for="university" class="form-label">University *</label>
										<input type="text" class="form-control" id="university" name="university" value="" required>
									</div>
									<div class="mb-3">
